...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/Word Finder.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/Word Finder.data.unityweb',
                        frameworkUrl: 'Build/Word Finder.framework.js.unityweb',
                        codeUrl: 'Build/Word Finder.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'DefaultCompany',
                        productName: 'The Word Finder',
                        productVersion: '1.0',
